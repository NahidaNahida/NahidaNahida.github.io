...
The home page can also render a ClustrMaps visitor map. Set `visits.clustrmapsScriptUrl` in `site-config.js` to the JavaScript URL generated by ClustrMaps, for example a `map_v2.js?...` URL. The visitor map is rendered only on the home page.
